...
export default function HowItWorksPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      <h1 className="font-display text-3xl font-bold text-[var(--black)]">How Nova Rides works</h1>
      <p className="mt-4 text-[var(--grey-600)]">
      ...
      <div className="mt-12 space-y-8">
        <section>
          <h2 className="font-display text-xl font-bold text-[var(--accent)]">For renters</h2>
          <ol className="mt-4 list-decimal list-inside space-y-2 text-[var(--grey-600)]">
        ...
        <section>
          <h2 className="font-display text-xl font-bold text-[var(--accent)]">For hosts</h2>
          <ol className="mt-4 list-decimal list-inside space-y-2 text-[var(--grey-600)]">
      ...
      <p className="mt-12">
        <Link href="/search" className="text-[var(--accent)] hover:underline">Find a car →</Link>
      </p>
    </div>
  );
}
